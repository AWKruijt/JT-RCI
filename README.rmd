...
If such cases occur and are problmeatic, the more 'simple' reliable change indices can be used (set parameter 'indextype = "RCI"'). Reliable change indices can also be used for comparison of groups preselected to (likely) differ at baseline on the measure assessed. 
